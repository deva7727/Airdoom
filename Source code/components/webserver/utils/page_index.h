    ...
    "function updateConfigurableFields(el){\n"
        ...
        "switch(parseInt(el.value)){\n"
            ...
            "case AttackTypeEnum.ATTACK_TYPE_HANDSHAKE:\n"
                ...
                "// Removed Rogue AP (0) because it's unreliable for cracking on single ESP32\n"
                "setAttackMethods([\n"
                    "{text: \"DEAUTH_BROADCAST (ACTIVE)\", value: 1}, \n"
                    "{text: \"CAPTURE_ONLY (PASSIVE)\", value: 2}\n"
                "]);\n"
                "break;\n"
            "case AttackTypeEnum.ATTACK_TYPE_PMKID:\n"
            ...
            "case AttackTypeEnum.ATTACK_TYPE_DOS:\n"
                ...
                "setAttackMethods([\n"
                    "{text: \"DEAUTH_BROADCAST (ACTIVE)\", value: 0}, // For DoS, indices are different\n"
                    "{text: \"ROGUE_AP (JAMMER)\", value: 1},\n"
                    "{text: \"COMBINE_ALL\", value: 2}\n"
                "]);\n"
                "break;\n"
            "default:\n"
